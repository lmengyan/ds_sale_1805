...
public class CartServiceImpl implements CartService{
    ...
    @Override
    public void saveCartList(List<TMallShoppingCar> carList, Integer userId) {
        Map<String,Object> map=new HashMap<>();
        map.put("cartList",carList);
        map.put("userId",userId);
        cartMapper.saveCartList(map);
    }

    @Override
    public TMallShoppingCar findCartBySkuIdAngUserId(Integer skuId, Integer userId) {
        return cartMapper.findCartBySkuIdAngUserId(skuId,userId);
    }
